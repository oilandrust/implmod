...
class CompactBvh{
	public :
		...
		void initialize(int node,const vector<AABBLite>& aabbs);
		void initializeSplit(int node,const vector<AABBLite>& aabbs);
		void buildNode(int node,const vector<AABBLite>& primitives, const vector<MetaPrimitive*>& splitPrimitives);
		void buildNodeNoOverlap(int node,const vector<AABBLite>& primitives, const vector<MetaPrimitive*>& splitPrimitives);
		void clear();
};
