#ifndef __GLGRAPHICS_MYTRACKBALL_H__
#define __GLGRAPHICS_MYTRACKBALL_H__
...
namespace GLGraphics
{
	...
	public:
		...
		MyQuatTrackBall(const CGLA::Vec3f&, float, unsigned, unsigned);
		...
		void grab_ball(MyTrackBallAction,const CGLA::Vec2i&);
		...
		MyTrackBallAction get_current_action() 
		{
